...
[^blogdown]: If you want to be really fancy, you can use [blogdown](https://bookdown.org/yihui/blogdown/), which makes a complete website with R Markdown files. That's actually how this site is built ([see the source code](https://github.com/de-barros/educ265-24)). You can build your own site [with this tutorial](https://www.apreshill.com/blog/2020-12-new-year-new-blogdown/).
